...
{{-- yaha hame old file ke liye input liya loop me hi isliye name array me liya --}}
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="primary-pills-home" role="tabpanel">
                                ...
                                <form class="row g-2" class="row g-2"  style="border:#cccccc solid 2px;" method="post" action="{{ route('FE.update') }} " enctype="multipart/form-data">
                                    @csrf
                                ...
                                <table width="100%" style="margin-top:0; ">
                                    ...
                                    <tr border="1" width="100%">
                                        ...
                                        <td border="1" width="10%">
                                            ...
                                            name="contact_no" value="{{ $new_edit->contact_no }}" required >
                                            </div>
                                        </td>
                                        <td border="1" width="10%">
                                            <div style="padding:3px;">
                            ...
                            Whether Boundaries Matching
                             ...
                             {{-- <td>{{ $new->plot_area }}</td>  --}}
                               ...
                               {{-- <td> --}}
                                ...
                                {{-- <td>
                                    @foreach ($new->image as $new1)
                                     
                                    <a target="_blank" href="{{ asset('images/FE-valuation/' . $new1) }}">
                                        <img src="{{ asset('images/FE-valuation/' . $new1) }}"
