                                                                                    ...
                                                                                    @foreach ($edit_data->document_name as $demo)
                                                                                        <tr>
                                                                                            <div class="col-md-4">
                                                                                                ...
                                                                                                <th>
                                                                                                    <a href="{{ asset('images/FE-valuation/' . $edit_data->image[$loop->index]) }}"
                                                                                                        download>
                ...
                <table width="100%" style="margin-top:0; ">
                    ...
                    <tr border="1" width="100%">
                        ...
                        <td border="1" width="10%">
                            ...
                            name="contact_no" value="{{ $new_edit->contact_no }}"  >
                            </div>
                        </td>
                        <td border="1" width="10%">
                            <div style="padding:3px;">
                        ...
                        <td border="1" width="25%">
                            <div style="padding:2px;">
                               ...
                               <input type="text" class="form-control"  rows="1" name="address" value="{{ $new_edit->address }}"  >
                            </div> 
                        </td>
                    ...
                    <table width="100%" style="margin-top:0;">
                        ...
                        <tr border="1" width="100%">
                            ...
                            <td border="1" width="15%" colspan="5">
                               ...
                               <input type="text" class="form-control" placeholder=" Road Name" name="road_name"
                    ...
                    <table width="100%" style="margin-top:0;">
                      ...
                      <table width="100%" style="margin-top:0;">	
                        ...
                        <input type="date" class="form-control datepicker" name="GF"  meter_no  value="{{$new_edit->GF  }}" >
                              </div> 
                          </td>
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                           ...
                           <td border="1" width="14%">
                            ...
                            name="side_marginal_distance_in_feet[]"  value="{{ $new_edit->side_marginal_distance_in_feet[0]}}">
                              </div>
                          </td>
                           <td border="1" width="16%">
                              <div style="padding:2px;">
                                  <label for="inputFirstName" class="form-label" style="margin-bottom:-5px">Ground Floor</label>
                                  <input type="text" class="form-control" placeholder=""
                            name="discription_of_property[]"  value="{{ $new_edit->discription_of_property[0]}}">
                          </td>
                        </tr>
                          ...
                          <td border="1" width="14%">
                           ...
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                                ...
                                <input type="text" class="form-control" placeholder="" name="up_area[]"
                             value="{{$new_edit->up_area[1]  }}">
                              </div>
                          </td>
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                                  <label for="inputFirstName" class="form-label" style="margin-bottom:-5px">First Floor</label>
                                <input type="date" class="form-control datepicker" name="FF"   value="{{$new_edit->FF  }}">
                              </div> 
                          </td>
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                           ...
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                                 ...
                                 <input type="text" class="form-control" placeholder=""
                            name="side_marginal_distance_in_feet[]"  value="{{ $new_edit->side_marginal_distance_in_feet[1]}}">
                              </div>
                          </td>
                           <td border="1" width="16%">
                              <div style="padding:2px;">
                                  <label for="inputFirstName" class="form-label" style="margin-bottom:-5px">First Floor</label>
                                  <input type="text" class="form-control" placeholder=""
                            name="discription_of_property[]"  value="{{ $new_edit->discription_of_property[1]}}">
                              </div>
                          </td>
                        </tr>
                          ...
                          <td border="1" width="14%">
                           ...
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                                  <label for="inputFirstName" class="form-label" style="margin-bottom:-5px">Second Floor</label>
                                    <input type="text" class="form-control" placeholder="" name="up_area[]"
                             value="{{$new_edit->up_area[2]  }}">
                              </div>
                          </td>
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                                  <label for="inputFirstName" class="form-label" style="margin-bottom:-5px">Second Floor</label>
                                  <input type="date" class="form-control datepicker" name="SF"  value="{{$new_edit->SF  }}">
                              </div> 
                          </td>
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                           ...
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                                  ...
                                  <input type="text" class="form-control" placeholder=""
                            name="side_marginal_distance_in_feet[]"  value="{{ $new_edit->side_marginal_distance_in_feet[2]}}">
                              </div>
                          </td>
                           <td border="1" width="16%">
                              <div style="padding:2px;">
                                  <label for="inputFirstName" class="form-label" style="margin-bottom:-5px">Second Floor</label>
                                  <input type="text" class="form-control" placeholder=""
                            name="discription_of_property[]"  value="{{ $new_edit->discription_of_property[2]}}">
                              </div>
                          </td>
                        </tr>
                          ...
                          <td border="1" width="14%">
                           ...
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                                ...
                                <input type="text" class="form-control" placeholder="" name="up_area[]"
                             value="{{$new_edit->up_area[3]  }}">
                              </div>
                          </td>
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                                  <label for="inputFirstName" class="form-label" style="margin-bottom:-5px">Third Floor</label>
                                   <input type="date" class="form-control datepicker" name="TF"  value="{{$new_edit->TF  }}">
                              </div> 
                          </td>
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                           ...
                           <td border="1" width="14%">
                              <div style="padding:2px;">
                                ...
                                <input type="text" class="form-control" placeholder=""
                            name="side_marginal_distance_in_feet[]"  value="{{ $new_edit->side_marginal_distance_in_feet[3]}}">
                              </div>
                          </td>
                           <td border="1" width="16%">
                              <div style="padding:2px;">
                                  <label for="inputFirstName" class="form-label" style="margin-bottom:-5px">Third Floor</label>
                                  <input type="text" class="form-control" placeholder=""
                            name="discription_of_property[]"  value="{{ $new_edit->discription_of_property[3]}}">
                              </div>
                          </td>
                        </tr>
                       </table> 
                    ...
                    <table width="100%" style="margin-top:0;">
                        ...
                        <tr border="1" width="100%">
                            ...
                            <select class="multiple-select " data-placeholder="Choose anything"
                                ...
                                <option>Select</option>
                                <option value="ongoing"   @if ($new_edit->status == "ongoing") selected @endif>ongoing </option>
                                <option value="cancelled"   @if ($new_edit->status == "cancelled") selected @endif>cancelled </option>
                                <option value="completed"   @if ($new_edit->status == "completed") selected @endif> completed</option>
                                <option value="pending"   @if ($new_edit->status == "pending") selected @endif> pending</option>
                                    ...
                                    <td border="1" width="30%">
                                        <div style="padding:2px;">
                                            <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Reason</label>
...
<br>
						...
						Assistant Valuer
								...
								<div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
									<div class="accordion-body">
                                        <form class="row g-2" class="row g-2"  style="border:#cccccc solid 2px;" method="post" action="{{ route('tech_manager_update') }} " enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $new_edit->id }}">
                                            <table width="100%" style="margin-top:0;">
                                                <tr border="1" width="100%">
...
{{-- @json(count($new_edit->file_name)) --}}
                                                                        ...
                                                                        <tr>
                                                                            <div class="col-md-4">
                                                                               ...
                                                                               <th>
                                                                                ...
                                                                                <th>
                                                                                    <a href="{{ asset('images/AV-valuation/' . $new_edit->file[$loop->index]) }}" download> {{$new_edit->file[$loop->index]}}
                                                                                 </th></a><br>
                                                                                <div>
                                                                        </tr>
                                                                    @endforeach
                    ...
                    <br><br>
                        ...
                        <form method="post" action="{{ route('tech_head_update') }}" enctype="multipart/form-data">
@csrf
<input type="hidden" name="id" value="{{ $new_edit->id }}">
...
if (category && image_src) {
    var markup =
        '<tr><td><input type="checkbox" class="del_check" name="record"></td><td><input type="hidden" value="' + $('#document1').val() +'" name="document_name[]"><input type="text" class="form-control"  document_name[] value="' + category +
