                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseOne1" class="accordion-collapse collapse"
                                     ...
                                     <form class="row g-2" class="row g-2" style="border:#cccccc solid 2px;"
                                        method="post" action="{{ route('FE.update') }} " enctype="multipart/form-data">
                                        @csrf
...
<hr>
                                    ...
                                    <tbody id="add_more3">
                                        @if (is_array($av_table->file_name))
                                            ...
                                            @foreach ($av_table->file_name as $cat)
                                                <tr>
                                                    <div class="col-md-4">
                                                        <th><input type="checkbox" class="del_check3" name="record">
                                                        </th>
                                                        <th>
                                                            <input type="text" class="form-control" placeholder=""
                                                                required
    ...
    <form method="post" action="{{ route('tech_manager_create') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="valuation_id" value="{{ $new_edit->valuation_id }}">
