                            ...
                            <tbody>
                                <tr>
                                    ...
                                    Whether Boundaries Matching
                                        ...
                                        <td>{{ $new_valuer_all->technical_manager_status }}</td>
                                        ...
                                        <td>
                                            ...
                                            @if(isset($new_valuer_all->technical_manager_id))
                                            <a href="{{ route('TM.tm_valuation_view',$new_valuer_all->id) }}"><button type="button" data-bs-toggle="modal"
