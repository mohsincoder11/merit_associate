                            ...
                            <form class="row g-2" action="{{ route('setting_insert') }} " method="post">@csrf
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputFirstName"
                                        placeholder="Documentation " name="documentation" required>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputFirstName"
                                        placeholder="  Filed Vist Approval" name="field_vist" required>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <label for="inputFirstName" class="form-label">Assistant Valuer Approval<span
                                            style="color:red"><span style="color:red">*</span></span></label>
                                    <input type="text" class="form-control" id="inputFirstName"
                                        placeholder=" Assistant Valuer Approval" name="assistant_valuer" required>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <label for="inputFirstName" class="form-label">Report Prepareation<span
                                            style="color:red"><span style="color:red">*</span></span></label>
                                    <input type="text" class="form-control" id="inputFirstName"
                                        placeholder="Report Prepareation " name="report_prepareation" required>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <label for="inputFirstName" class="form-label">Technical Head Approval<span
                                            style="color:red">*</span></label>
                                    <input type="text" class="form-control" id="inputFirstName"
                                        placeholder="Technical Head Approval" name="technical_head" required>
                                </div>
