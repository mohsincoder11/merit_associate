                                                ...
                                                <select class="form-select mb-3" aria-label="Default select example"
                                                    ...
                                                    @foreach ($emp as $emp1)
                                                        <option value="{{ $emp1->id }}"
                                                            @if ($edit_data->field_executive_id == $emp1->id) selected @endif>
                                                            {{ $emp1->name }} </option>
                                                    @endforeach
                                                ...
                                                <select class="form-select mb-3" aria-label="Default select example"
                                                    ...
                                                    @foreach ($emp as $emp2)
                                                        <option value="{{ $emp2->id }}"
                                                            @if ($edit_data->assistant_valuer_id == $emp2->id) selected @endif>
                                                            {{ $emp2->name }} </option>
                                                    @endforeach
                                        ...
                                        <td border="1" width="15%">
                                            <div style="padding:2px;">
                                                ...
                                                <select class="form-select mb-3" aria-label="Default select example"
                                                    ...
                                                    @foreach ($emp as $emp3)
                                                        <option value="{{ $emp3->id }}"
                                                            @if ($edit_data->technical_manager_id == $emp3->id) selected @endif>
                                                            {{ $emp3->name }} </option>
                                                    @endforeach
                                        ...
                                        <td border="1" width="15%">
                                            <div style="padding:2px;">
                                                ...
                                                <select class="form-select mb-3" aria-label="Default select example"
                                                    ...
                                                    @foreach ($emp as $emp4)
                                                        <option value="{{ $emp4->id }}"
                                                            @if ($edit_data->technical_head_id == $emp4->id) selected @endif>
                                                            {{ $emp4->name }} </option>
                                                    @endforeach
                        ...
                        $update ->valuation_id= $request->valuation_id; --}}
                                            ...
                                            <table width="100%" style="margin-top:0;">
                                                ...
                                                <tr border="1" width="100%">
                                                    ...
                                                    <td border="1" width="14%">
                                                        <div style="padding:5px;">
                                                            <label for="inputFirstName" class="form-label"
                                                                style="margin-bottom:-5px"> Select</label>
                                                            <select class="multiple-select"
                                                                data-placeholder="Choose anything"
                                                                name="whether_boundaries_matching[]">
                                                                <option value="">Select</option>
                                    ...
                                    <td border="1" width="14%">
                                        <div style="padding:2px;">
                                            <label for="inputFirstName" class="form-label"
                                                style="margin-bottom:-5px">Second Floor</label>
                                            <input type="date" class="form-control datepicker" name="SF"
                                                value="">
                                        </div>
                                    </td>
                                    <td border="1" width="14%">
                                    ...
                                    <tr border="1" width="100%">
                                        ...
                                        <td border="1" width="14%">
                                            <div style="padding:2px;">
                                                <label for="inputFirstName" class="form-label"
                                                    style="margin-bottom:-5px">Third Floor</label>
                                                <input type="date" class="form-control datepicker" name="TF"
                                                    value="">
                                            </div>
                                        </td>
                                        <td border="1" width="14%">
                                                ...
                                                <div style="padding:3px;">
                                                    ...
                                                    <select class="multiple-select" data-placeholder="Choose anything"
                                                        ...
                                                        <option value="Kaccha Roa"
                                                            @if ($new_edit->road_type == 'Kaccha Roa') selected @endif>Kaccha Road
                                                        </option>
                                                    </select>
                                                </div>
                                            </td>
                                            ...
                                            <td border="1" width="10%" colspan="6">
                                                <div style="padding:2px;">
                                                    ...
                                                    <select class="multiple-select" data-placeholder="Choose anything"
                                                        ...
                                                        <option value="">Select</option>
                                                        <option value="RCC"
                                                            @if ($new_edit->type_of_structure == 'Tar Road') selected @endif>RCC</option>
                                                        <option value="Load Bearins"
                                                            @if ($new_edit->type_of_structure == 'Load Bearins') selected @endif>Load Bearing
                                                        </option>
                                                        <option value="Composite"
                                                            @if ($new_edit->type_of_structure == 'Composite') selected @endif>Composite
                                                        </option>
                                                        <option value="Tin Roof"
                                                            @if ($new_edit->type_of_structure == 'Tin Roof') selected @endif>Tin Roof
                                                        </option>
                                                        <option value="RCC + Tin Roof"
                                                            @if ($new_edit->type_of_structure == 'RCC + Tin Roof') selected @endif>RCC + Tin
                                                            Roof</option>
                                                        <option value="Kaccha House"
                                                            @if ($new_edit->type_of_structure == 'Kaccha House') selected @endif>Kaccha House
                                                        </option>
                                    ...
                                    <table width="100%" style="margin-top:0;">
                                        ...
                                        <tr border="1" width="100%">
                                                ...
                                                <div style="padding:2px;">
                                                    ...
                                                    <select class="multiple-select" data-placeholder="Choose anything"
                                                        ...
                                                        <option value="Yet To Start"
                                                            @if ($new_edit->construction_stage == 'Yet To Start') selected @endif>Yet To Start
                                                        </option>
                                                        <option value="Ground Level"
                                                            @if ($new_edit->construction_stage == 'Ground Level') selected @endif>Ground Level
                                                        </option>
                                                        <option value="Plinth Level"
                                                            @if ($new_edit->construction_stage == 'Plinth Level') selected @endif>Plinth Level
                                                        </option>
                                                        <option value="Roof Level"
                                                            @if ($new_edit->construction_stage == 'Roof Level') selected @endif>Roof Level
                                                        </option>
                                                        <option value="Finishing Stage"
                                                            @if ($new_edit->construction_stage == 'Finishing Stage') selected @endif>Finishing
                                                            Stage</option>
                                            ...
                                            <td border="1" width="15%">
                                                <div style="padding:3px;">
                                                    ...
                                                    <select class="multiple-select" data-placeholder="Choose anything"
                                                        ...
                                                        <option value="N.A"
                                                            @if ($new_edit->relation_with_owner == 'N.A') selected @endif>N.A</option>
                                                    </select>
                                                </div>
                                            </td>
                                            ...
                                            <td border="1" width="20%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label"
                                                        style="margin-bottom: -5px;">Deviation (Mark Appropriate)*</label>
                                                    <select class="multiple-select" data-placeholder="Choose anything"
                                                        name="deviation">
                                                        <option value="">Select</option>
                                                        <option value="High Tension Line"
                                                            @if ($new_edit->deviation == 'High Tension Line') selected @endif>High Tension
                                                            Line</option>
                                                        <option value="Temple In Property"
                                                            @if ($new_edit->deviation == 'Temple In Property') selected @endif>Temple In
                                                            Property</option>
                                                        <option value="Near Nala / River/ Water Body"
                                                            @if ($new_edit->deviation == 'Near Nala / River/ Water Body') selected @endif>Near Nala /
                                                            River/ Water
                                                            Body</option>
                                                        <option value="Land Lock Property"
                                                            @if ($new_edit->deviation == 'Land Lock Property') selected @endif>Land Lock
                                                            Property</option>
                                                        <option value="Common Entrance"
                                                            @if ($new_edit->deviation == 'Common Entrance') selected @endif>Common
                                                            Entrance</option>
                                                        <option value="Railway Line"
                                                            @if ($new_edit->deviation == 'Railway Line') selected @endif>Railway Line
                                                        </option>
                                                    </select>
                                                </div>
                                            </td>
                                            ...
                                            <td border="1" width="10%">
                                                <div style="padding:3px;">
                                                    ...
                                                    <select class="multiple-select " data-placeholder="Choose anything"
                                                        ...
                                                        {{-- @foreach ($location as $location)
                                                                <option value="{{ $location->id }}"
                                                                    @if ($new_edit->location_id == $location->id) selected @endif>
                                            ...
                                            <td border="1" width="10%">
                                                <div style="padding:2px;">
                                                    ...
                                                    <select class="form-select" name="status">
                                                        ...
                                                        <option value="cancelled"
                                                            @if ($new_edit->status == 'cancelled') selected @endif>cancelled
                                                        </option>
                                                        <option value="completed"
                                                            @if ($new_edit->status == 'completed') selected @endif> completed
                                                        </option>
                                                        <option value="pending"
                                        ...
                                        <tr border="1" width="100%">
                                            ...
                                            <td border="1" width="10%">
                                                <div class="form-group" align="center"
                                                    ...
                                                    <button type="button" class="btn btn-warning " id="add_row1"><i
                                                    ...
                                                    <tbody id="add_more1">
                                                        ...
                                                        @if (is_array($new_edit->category_id))
                                                            ...
                                                            @foreach ($new_edit->category_id as $cat)
                                                                <tr>
                                                                    <div class="col-md-4">
                                                                        <th><input type="checkbox" class="del_check13"
                                                                                name="record">
                                                                        </th>
                                                                        <th>
