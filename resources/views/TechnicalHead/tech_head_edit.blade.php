                             ...
                             <form class="row g-2" style="border:#cccccc solid 2px;" method="post"
                                                            ...
                                                            <div style="padding:3px;">
                                                                ...
                                                                <a  href="" data-bs-toggle="modal" data-bs-target="#exampleScrollableModal" style="color:blue">[Add New]</a> 
                                                                                    ...
                                                                                    <select class="form-select mb-3 areas" aria-label="Default select example"
                                                                                        ...
                                                                                        <option value="{{$new_location->id}}" @if ($edit_data->area_id == $new_location->id) selected 
                                                                                        @endif >{{$new_location->area}} </option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                            </div>
                                        ...
                                        <table width="100%" style="margin-top:0;">
                                            <tr border="1" width="100%">
                                                ...
                                                <option value="{{ $status->id }}" @if ($edit_data->status == $status->id)  selected @endif> {{ $status->statu }}
                                                </option>
                                         @endforeach
                                                        </select>
                                                </td>
...
<br>
                        ...
                        {{-- Field Exceutive --}}
                            ...
                            <div class="accordion accordion-flush" id="accordionFlushExample2">
                                ...
                                <form class="row g-2" class="row g-2"  style="border:#cccccc solid 2px;" method="post" action="{{ route('update_fe') }} " enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="card-title d-flex align-items-center" style="margin:0; padding:0;">
                                    <table width="100%">
                                        <tr border="1" width="100%">
                                          <td border="1" width="70%" style="background-color: #D9FFD9; color:#000000; padding-top:5px; padding-bottom:5px;" colspan="8"><strong>&nbsp;&nbsp;Valuation Report</strong></td>
            {{-- $update ->valuation_id= $request->valuation_id;
            $update ->valuation_id= $request->valuation_id; --}}
                                          <td border="1" width="30%" style="background-color: #C6F3FF; color:#000000; padding-top:5px; padding-bottom:5px;" colspan="8" ><strong>&nbsp;&nbsp; <label> Valuation ID:</label><input name="valuation_id" style="border:none" value="{{ $new_edit->valuation_id }}" readonly></h5></strong></td>
                                ...
                                <table width="100%" style="margin-top:0; ">
                                    ...
                                    <tr border="1" width="100%">
                                        ...
                                        <td border="1" width="15%" colspan="5">
                                            <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Name Of Customer*</label>
                                        ...
                                        <td border="1" width="10%">
                                            <div style="padding:3px;">
                                                <label for="inputFirstName"  style="margin-bottom: -5px;" class="form-label">Customer Contact*</label>
                                                 <input type="text" class="form-control" placeholder=" Contact Number"
                                            name="contact_no" value="{{ $new_edit->contact_no }}" required maxlength="10"d>
                                            </div>
                                        </td>
                                        <td border="1" width="10%">
                                            <div style="padding:3px;">
                                                <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Property Type*</label>
                                            ...
                                            @foreach ($property_type as $property_type)
                                                <option value="{{ $property_type->id }}"  @if($new_edit->property_type_id ==$property_type->id) selected @endif>{{ $property_type->property }}</option>
                                            @endforeach
                                        </select>
                                            </div>
                                        </td>
                                    ...
                                    <table>
                                        <tr  width="100%">
                                            <td border="1" width="10%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">House No*</label>
                                                   <input type="text" class="form-control"  rows="1" name="house_no" value="{{ $new_edit->house_no }}" required >
                                                </div> 
        
                                            </td>
                                            <td border="1" width="15%" colspan="5">
                                                <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Road Name*</label>
                                               <input type="text" class="form-control"  name="road_name"
                                            required value="{{$new_edit->road_name  }}">
                                                </td> 
                                            <td border="1" width="15%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Building Name*</label>
                                                   <input type="text" class="form-control"  rows="1" name="building_name" value="{{ $new_edit->building_name }}"  >
                                                </div> 
        
                                            </td>
                                            <td border="1" width="10%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Wing No*</label>
                                                   <input type="text" class="form-control"  rows="1" name="wing_no" value="{{ $new_edit->wing_no }}"  >
                                                </div> 
        
                                            </td>
                                            <td border="1" width="15%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Colony*</label>
                                                   <input type="text" class="form-control"  rows="1" name="colony" value="{{ $new_edit->colony }}"  >
                                                </div> 
        
                                            </td>
                                            <td border="1" width="15%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Village/City/Town*</label>
                                                   <input type="text" class="form-control"  rows="1" name="village_city" value="{{ $new_edit->village_city }}"  >
                                                </div> 
        
                                            </td>
                                            <td border="1" width="10%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Tehsil*</label>
                                                   <input type="text" class="form-control"  rows="1" name="tehsil" value="{{ $new_edit->tehsil }}"  >
                                                </div> 
        
                                            </td>
                                            <td border="1" width="10%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">District*</label>
                                                   <input type="text" class="form-control"  rows="1" name="district" value="{{ $new_edit->district }}"  >
                                                </div> 
                                    ...
                                    <table width="100%" style="margin-top:0;">
                                        ...
                                        <tr border="1" width="100%">
                                            ...
                                            <td border="1" width="25%">
                                                <div style="padding:3px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Colony / Area/Nagar*</label>
                                                   <input type="text" class="form-control" placeholder=" Colony / Area/Nagar"
                                            name="colony" required value="{{$new_edit->colony  }}">
                                                </div>
                                            </td>
                                            <td border="1" width="10%">
                                                <div style="padding:3px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">PIN Code*</label>
                                            ...
                                            <td border="1" width="10%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Landmark*</label>
                                                     <input type="text" class="form-control" placeholder="Landmark" name="landmark"
                                            required value="{{$new_edit->landmark  }}">
                                                </div>
                                            </td>
                                            <td border="1" width="10%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">E-Meter No*</label>
                                                  <input type="text" class="form-control" placeholder="E-Meter No" name="meter_no"
                                            required value="{{$new_edit->meter_no  }}">
                                                </div> 
                                            </td>
                                            <td border="1" width="15%">
                                                <div style="padding:2px;">
                                                <label for="inputFirstName" class="form-label"  style="margin-bottom: -5px;">Occupancy Status*</label>
                                                <select class="multiple-select" data-placeholder="Choose anything"
                                                name="occupancy_status" required>
                                                <option value="">Select</option>
                                                <option value="Occupied" @if ($new_edit
                                                ->occupancy_status == 'Occupied') selected @endif>Occupied</option>
                                                <option value="Vacant"  @if ($new_edit
                                                ->occupancy_status == 'Vacant') selected @endif>Vacant</option>
                                                <option value="Under Construction"  @if ($new_edit
                                                ->occupancy_status == 'Under Construction') selected @endif>Under Construction</option>
                                                <option value="N.A"  @if ($new_edit
                                            ...
                                            <td border="1" width="15%">
                                                <div style="padding:2px;">
                                                <label for="inputFirstName" class="form-label"  style="margin-bottom: -5px;">Occupied By*</label>
                                                <select class="multiple-select" data-placeholder="Choose anything"
                                                name="occupied_by" required>
                                                <option value="">Select</option>
                                                <option value="Seller Occupied"  @if ($new_edit
                                                ->occupied_by == 'Seller Occupied') selected @endif>Seller Occupied</option>
                                                <option value="Self Occupied"  @if ($new_edit
                                                ->occupied_by == 'Self Occupied') selected @endif>Self Occupied</option>
                                                <option value="Tenant Occupied"  @if ($new_edit
                                                ->occupied_by == 'Tenant Occupied') selected @endif>Tenant Occupied</option>
                                                <option value="Self + Tenant"  @if ($new_edit
                                     ...
                                     &nbsp;
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="plot_area[]" value="{{ $new_edit->plot_area[0] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="plot_area[]" value="{{ $new_edit->plot_area[1] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="plot_area[]" value="{{ $new_edit->plot_area[2] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="plot_area[]" value="{{ $new_edit->plot_area[3] }}"> 
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="up_area[]" value="{{ $new_edit->up_area[0] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="up_area[]" value="{{ $new_edit->up_area[1] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="up_area[]" value="{{ $new_edit->up_area[2] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="up_area[]" value="{{ $new_edit->up_area[3] }}">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="date" class="form-control" placeholder="" name="GF" value="{{ $new_edit->GF }}">
    
                                                </td>
                                                <td>
                                                    <input type="date" class="form-control" placeholder="" name="FF" value="{{ $new_edit->FF }}">
    
                                                </td>
                                                <td>
                                                    <input type="date" class="form-control" placeholder="" name="SF" value="{{ $new_edit->SF }}">
    
                                                </td>
                                                <td>
                                                    <input type="date" class="form-control" placeholder="" name="TF" value="{{ $new_edit->TF }}">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="four_borders[]" value="{{ $new_edit->four_borders[0] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="four_borders[]" value="{{ $new_edit->four_borders[1] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="four_borders[]" value="{{ $new_edit->four_borders[2] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="four_borders[]" value="{{ $new_edit->four_borders[3] }}">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="side_marginal_distance_in_feet[]" value="{{ $new_edit->side_marginal_distance_in_feet[0] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="side_marginal_distance_in_feet[]" value="{{ $new_edit->side_marginal_distance_in_feet[1] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="side_marginal_distance_in_feet[]" value="{{ $new_edit->side_marginal_distance_in_feet[2] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="side_marginal_distance_in_feet[]" value="{{ $new_edit->side_marginal_distance_in_feet[3] }}">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="discription_of_property[]" value="{{ $new_edit->discription_of_property[0] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="discription_of_property[]" value="{{ $new_edit->discription_of_property[1] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="discription_of_property[]" value="{{ $new_edit->discription_of_property[2] }}">
    
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" placeholder="" name="discription_of_property[]" value="{{ $new_edit->discription_of_property[3] }}">
...
{{--     
    ...
    <hr>
                                ...
                                <table width="100%" style="margin-top:0px;">
                                    ...
                                    <tr border="1" width="100%">
                                        ...
                                        <td border="1" width="7%" colspan="6">
                                            <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Rate Range *</label>
                                          <input type="text" class="form-control" placeholder="" name="rate_range"
                                                 value="{{ $new_edit->rate_range }}">
    
                                            </td> 
    
                                        <td border="1" width="7%">
                                            <div style="padding:3px;">
                                                <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Plot Rate *</label>
                                                 
                                            <input type="text" class="form-control" placeholder="" name="plot_range"
                                                 value="{{ $new_edit->plot_range }}">
                                            </div>
                                        </td>
                                        <td border="1" width="10%">
                                            <div style="padding:3px;">
                                               ...
                                               <select class="multiple-select" data-placeholder="Choose anything"
                                                ...
                                                <option value="WBM Road" @if($new_edit->road_type =="WBM Road") selected @endif>WBM Road</option>
                                                <option value="Kaccha Roa" @if($new_edit->road_type =="Kaccha Roa") selected @endif>Kaccha Road</option>
                                            </select>
                                            </div>
                                        </td>
                                        <td border="1" width="10%">
                                            <div style="padding:2px;">
                                                <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Road Width In Feet*</label>
                                                  <input type="text" class="form-control" placeholder=""
                                                name="road_width_in_feet"  value="{{ $new_edit->road_width_in_feet }}">
                                         
                                            </div>
                                        </td>
                                        <td border="1" width="10%" colspan="6">
                                            <div style="padding:2px;">
                                                <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Type of structure *</label>
                                               <select class="multiple-select" data-placeholder="Choose anything"
                                                name="type_of_structure" >
                                                <option value="">Select</option>
                                                <option value="RCC" @if($new_edit->type_of_structure =="Tar Road") selected @endif>RCC</option>
                                                <option value="Load Bearins" @if($new_edit->type_of_structure =="Load Bearins") selected @endif>Load Bearing</option>
                                                <option value="Composite" @if($new_edit->type_of_structure =="Composite") selected @endif>Composite</option>
                                                <option value="Tin Roof" @if($new_edit->type_of_structure =="Tin Roof") selected @endif>Tin Roof</option>
                                                <option value="RCC + Tin Roof" @if($new_edit->type_of_structure =="RCC + Tin Roof") selected @endif>RCC + Tin Roof</option>
                                                <option value="Kaccha House" @if($new_edit->type_of_structure =="Kaccha House") selected @endif>Kaccha House</option>
                                        ...
                                        <td border="1" width="22%">
                                            <div style="padding:3px;">
                                                <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;"> Remark On Boundaries Matching
                                                    *</label>
                                                 
                                                    <input type="text" class="form-control" placeholder=""
                                                    name="remark_on_boundaries_matching"  value="{{ $new_edit->remark_on_boundaries_matching }}">
                                            </div>
                                        </td>
                                        <td border="1" width="7%">
                                            <div style="padding:3px;">
                                                <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">LAT *</label>
                                        ...
                                        <td border="1" width="7%">
                                            <div style="padding:2px;">
                                                <label for="inputFirstName" class="form-label"  style="margin-bottom: -5px;">Long*</label>
                                    ...
                                    <table width="100%" style="margin-top:0;">
                                        ...
                                        <tr border="1" width="100%">
                                            ...
                                            <td border="1" width="12%">
                                                ...
                                                <option value="Plinth Level" @if($new_edit->construction_stage =="Plinth Level") selected @endif>Plinth Level</option>
                                                <option value="Roof Level" @if($new_edit->construction_stage =="Roof Level") selected @endif>Roof Level</option>
                                                <option value="Finishing Stage" @if($new_edit->construction_stage =="Finishing Stage") selected @endif>Finishing Stage</option>
                                                <option value="Superstructure Completed (For Multistorey)" @if($new_edit->construction_stage =="Superstructure Completed (For Multistorey)") selected @endif>
                                            ...
                                            <td border="1" width="15%" colspan="6">
                                                <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Person Met At Site*</label>
                                               <input type="text" class="form-control" placeholder=""
                                            name="person_met_at_site"  value="{{ $new_edit-> person_met_at_site}}">
                                            ...
                                            <option value="Wife" @if($new_edit->relation_with_owner =="Wife") selected @endif>Wife</option>
                                            <option value="Neighbor" @if($new_edit->relation_with_owner =="Neighbor") selected @endif>Neighbor</option>
                                            <option value="Husband" @if($new_edit->relation_with_owner =="Husband") selected @endif>Husband</option>
                                            <option value="Company Employee" @if($new_edit->relation_with_owner =="Company Employee") selected @endif>Company Employee</option>
                                            <option value="Buider / Site Supervisior" @if($new_edit->relation_with_owner =="Buider / Site Supervisior") selected @endif>Buider / Site Supervisior
                                            </option>
                                            <option value="N.A" @if($new_edit->relation_with_owner =="N.A") selected @endif>N.A</option>
                                        </select>
                                                </div>
                                            </td>
                                            ...
                                            <td border="1" width="15%">
                                                <div style="padding:3px;">
                                                    <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Remark on Property*</label>
                                                   <input type="text" class="form-control" placeholder=""
                                            name="remark_on_property"  value="{{ $new_edit->remark_on_property }}">
                                                </div>
                                            </td>
    
                                            <td border="1" width="20%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label"  style="margin-bottom: -5px;">Deviation (Mark Appropriate)*</label>
                                                     <select class="multiple-select" data-placeholder="Choose anything"
                                            name="deviation" >
                                            <option value="">Select</option>
                                            <option value="High Tension Line"  @if($new_edit->deviation =="High Tension Line") selected @endif>High Tension Line</option>
                                            <option value="Temple In Property"  @if($new_edit->deviation =="Temple In Property") selected @endif>Temple In Property</option>
                                            <option value="Near Nala / River/ Water Body"  @if($new_edit->deviation =="Near Nala / River/ Water Body") selected @endif>Near Nala / River/ Water
                                                Body</option>
                                            <option value="Land Lock Property"  @if($new_edit->deviation =="Land Lock Property") selected @endif>Land Lock Property</option>
                                            <option value="Common Entrance"  @if($new_edit->deviation =="Common Entrance") selected @endif>Common Entrance</option>
                                            <option value="Railway Line"  @if($new_edit->deviation =="Railway Line") selected @endif>Railway Line</option>
                                        </select>
                                                </div>
                                            </td>
                                            <td border="1" width="23%">
                                                <div style="padding:2px;">
                                                    <label for="inputFirstName" class="form-label"  style="margin-bottom: -5px;">Rate Referenace (name&contact)*</label>
                                                      <input type="text" class="form-control" placeholder="" name="rate_referenace"
                                            ...
                                            <table width="100%" style="margin-top:0;">
                                                ...
                                                <tr border="1" width="100%">
                                                    <td border="1" width="10%">
                                                        <div style="padding:2px;">
                                                            <label for="inputFirstName" class="form-label"  style="margin-bottom: -5px;">Date Of Visit*</label>
                                                               <input type="date" class="form-control datepicker" name="date_of_visit"
                                                     value="{{ $new_edit->date_of_visit}}">
                                                        </div>
                                                    </td>
                                                    <td border="1" width="30%">
                                                        <label for="inputFirstName" class="form-label"  style="margin-bottom: -5px;">Name Of Field Executive Visited The Property*</label>
                                                     <input type="text" class="form-control" placeholder=""
                                                name="name_of_FE_visited_the_property" value="{{ $new_edit->name_of_FE_visited_the_property_id }}"
                                                >
                                                        </td> 
                
                                                    <td border="1" width="10%">
                                                        <div style="padding:3px;">
                                                            <label for="inputFirstName"  style="margin-bottom: -5px;" class="form-label">Location*</label>
                                                          <label id="location"> </label>
    
    
    
                                            <select class="multiple-select " data-placeholder="Choose anything"
                                                name="location_id"  id="location" @readonly(true)>
                                                <option value="">Select</option>
                                              ...
                                              {{-- @json($role) --}}
                                                    <td border="1" width="10%">
                                                        <div>
                                                            ...
                                                            <select class="form-select"  name="last_updated_by" required>
                                                                ...
                                                                <option value="{{$roles->id}}" @if (Auth::user()->role_name_id ==$roles->id ) selected
                                                                @endif>{{$roles->role_name}} </option>  
                                                                @endforeach
                                                    ...
                                                    <td border="1" width="10%">
                                                        <div style="padding:2px;">
                                                        <label for="inputFirstName" class="form-label"  style="margin-bottom: -5px;">Status</label>
                                                         <select class="form-select"  name="status">
                                                {{-- <option>Select</option> --}}
                                                @foreach ($status_FE as $status_FE)
                                                <option value="{{ $status_FE->id }}" @if ($edit_data->status == $status_FE->id)  selected
                                                @endif > {{ $status_FE->statu }}
                                                </option>
                                          @endforeach
                                            </select>
                                                        </div>
                                                    ...
                                                    <td border="1" width="30%">
                                                        <div style="padding:2px;">
                                                            <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Remarks</label>
                                                          <textarea class="form-control" id="inputAddress" placeholder="reason / remarks" rows="1" name="reason" required>{{$new_edit->reason}}</textarea>
                                                        </div> 
                                                    </td>
                            ...
                            <table width="100%" style="margin-top:0;">
                                <tr border="1" width="100%">
                                    ...
                                    <td border="1" width="15%" >
                                        <div style="padding:3px;">
                                            <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Category*</label>
                                ...
                                @endforeach
                                    ...
                                    <td border="1" width="15%">
                                        <div style="padding:2px;">
                                            <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Tags*</label>
                                             <select class="multiple-select first_input" data-placeholder="Choose anything"
                                 id="tag">
                                <option value="">Select</option>
                            ...
                            @endforeach
                                 ...
                                 {{-- @foreach ($tags as $tags)
                                    ...
                                    <td border="1" width="30%">
                                        <div style="padding:2px;">
                                            <label for="inputFirstName" class="form-label" style="margin-bottom: -5px;">Image*</label>
                                ...
                                accept="image/*" id="image1">
                                    ...
                                    <td border="1" width="10%">
                                        <div class="form-group" align="center" style="margin-top:20px; float:left;">
                                            <button type="button"  class="btn btn-warning " id="add_row1"><i class='bx bx-plus me-0'></i></button>
                                        </div>
                                    ...
                                    <td border="1" width="10%">
                                        <div class="form-group" align="center" style="margin-top:20px;">
                                            {{-- <button type="button" class="delete-row  " --}}
                                            {{-- style=" margin-top: 5px; color:red"><i class="bx bx-trash"></i></button> --}}
                                            <button type="button" class="btn btn-danger delete-row1"><i class='bx bx-trash me-0'></i></button>
                                        </div>
                                    </td>
                                                    ...
                                                    <tr>
                                                        <div class="col-md-4">
                                                           ...
                                                           <th>
                                                            ...
                                                            <th>
                                                                {{-- <input type="hidden" value="{{$new_edit->image[$loop->index]}}" name="old_image[]"> --}}
                                                                <a href="{{ asset('images/AV-valuation/' . $av_table->file[$loop->index]) }}" download> {{$av_table->file[$loop->index]}}
                                                             </th></a><br>
                                                            <div>
                                                    </tr>
                                                @endforeach
                                ...
                                <tr border="1" width="100%" colspan="5">
                                    ...
                                    <td border="1" width="20%">
                                        <div style="padding:2px;">
                                            ...
                                            <select class="form-select" name="status">
                                                ...
                                                <option value="{{ $status_AV->id }}" @if ($av_table->status == $status_AV->id)  selected
                                                @endif > {{ $status_AV->statu }}
                                                </option>
                                          @endforeach
                                    ...
                                    <td border="1" width="20%">
                                        <div style="padding:2px;">
                                            ...
                                            <textarea class="form-control" id="inputAddress" placeholder="reason / remarks" rows="2" name="reason" required>{{$av_table->reason}}</textarea>
                                        </div>
                                    </td>
				...
				{{-- Technical Manager --}}
                        ...
                        <form method="post" action="{{ route('tech_manager_update_new') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="valuation_id" value="{{ $new_edit->valuation_id }}">
        ...
        <table width="100%" style="margin-top:0;">
            <tr border="1" width="100%">
                ...
                <td border="1" width="10%">
                    ...
                    <div class="form-group" align="center" style="margin-top:30px;">
                        <button type="button" name="action_button" class="btn btn-warning " id="add_row4"><i
                                class='bx bx-plus me-0'></i> Add</button>
                    </div>
                ...
                <td border="1" width="10%">
                    ...
                    <div class="form-group" align="center" style="margin-top:30px;">
                        {{-- <button type="button" class="delete-row  " --}}
                        {{-- style=" margin-top: 5px; color:red"><i class="bx bx-trash"></i></button> --}}
                        <button type="button" class="btn btn-danger delete-row4"><i class='bx bx-trash me-0'></i>
                            Delete</button>
                    </div>
                                ...
                                <tr>
                                    <div class="col-md-4">
                                       ...
                                       <th>
                                        ...
                                        <th>
                                            {{-- <input type="hidden" value="{{$new_edit->image[$loop->index]}}" name="old_image[]"> --}}
                                            <a href="{{ asset('images/AV-valuation/' . $tm_table->file[$loop->index]) }}" download> {{$tm_table->file[$loop->index]}}
                                         </th></a><br>
                                        <div>
                                </tr>
                            @endforeach
    ...
    <form method="post" action="{{ route('technicalhead_update_new') }}">
        @csrf
        <input type="hidden" name="valuation_id" value="{{ $new_edit->valuation_id }}">
                ...
                <div class="col-md-6 " style="float-left">
                    ...
                    <table class="items_table table table-bordered width80" id="items_table">
                        ...
                        <tbody id="add_more5">
                            ...
                            @foreach ($td_table->file_name as $cat)
                                <tr>
                                    <div class="col-md-4">
                                        <th><input type="checkbox"
                                                class="del_check3" name="record">
                                       ...
                                       <th>
                                            <input type="text"
                                                class="form-control" placeholder=""
                                                required
                                                value="{{$td_table->file_name[$loop->index] }}">
                                        </th>

                                        <th>
                                            {{-- <input type="hidden" value="{{$new_edit->image[$loop->index]}}" name="old_image[]"> --}}
                                            <a href="{{ asset('images/TD-valuation/' . $td_table->file[$loop->index]) }}" download> {{$td_table->file[$loop->index]}}
                                         </th></a><br>
                                        <div>
                                </tr>
                            @endforeach
            ...
            <tr border="1" width="100%" colspan="5">
                ...
                <td border="1" width="20%">
                    <div style="padding:2px;">
                        ...
                        <select class="form-select" name="status">
                            ...
                            <option value="{{ $status->id }}"  @if ($td_table->status == $status->id) selected @endif>
                                {{ $status->statu }}
                            </option>
                        @endforeach
                ...
                <td border="1" width="20%">
                    <div style="padding:2px;">
                        ...
                        <textarea class="form-control" id="inputAddress" placeholder="reason / remarks" rows="2" name="reason">{{$td_table->reason}}</textarea>
                    </div>
                </td>
