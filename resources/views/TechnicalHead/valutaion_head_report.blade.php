...
<div class="page-wrapper">
 ...
 <hr />
            ...
            <form method="post" action="{{ route('technicalhead_report') }}">
                @csrf
                                ...
                                <tr>
                                    @foreach ($new_valuer_all as $new_valuer_all)
                                        ...
                                        <td data-bs-toggle="tooltip" data-bs-placement="right" title="Property Address:- {{ $new_valuer_all->property_address }}
                                            ...
                                            Remark On Boundaries Matching:- {{ $new_valuer_all->remark_on_boundaries_matching }}">{{ $new_valuer_all->locations }}</td>
                                    ...
                                    Whether Boundaries Matching
                                        ...
                                        " >{{ date("d-m-Y  h:i a", strtotime($new_valuer_all->created_at)) }}</td>
                                        <td>{{ $new_valuer_all->technical_head_status }}</td>
                                        {{-- <td>{{ $new_valuer_all->last_updated_by }}</td> --}}

                                        <td>
                                            <a href="{{ route('technicalhead_edit', $new_valuer_all->id) }}"> <button type="button" 
                                                    class="btn1 btn-outline-success view"><i
                                                        class="lni lni-remove-file"></i></button></a>

                                                        @if(isset($new_valuer_all->technical_head_id))
                                                        <a href="{{ route('TD.td_valuation_view',$new_valuer_all->id) }}"><button type="button" data-bs-toggle="modal"
