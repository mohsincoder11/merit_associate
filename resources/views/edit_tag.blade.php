                ...
                <div class="col-md-8 mx-auto" style="margin-top: -10%;">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <form class="row g-2" method="post" action={{ route('tagupdate') }}>@csrf
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="category_id">
                                        ...
                                        <option value="{{ $data1->id }}" @if($edit_data->category_id ==$data1->id) selected @endif>{{ $data1->category }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputFirstName" name="tag" placeholder="Tags" required value="{{ $edit_data->tag }}">
                                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            @foreach($all_tag as $all_tag)
                                           <td>{{ $loop->index+1 }}</td>
                                            <td>{{ $all_tag->category }}</td>
                                            <td> {{ $all_tag->tag }}</td>
                                            <td> 
