...
class FloorController extends Controller
{
    ...
    public function index_cat()
    {
        ...
        return view('floor_category',compact('data2','data'));
    }
    ...
    return view('edit_floor',['edit_floor'=>$edit_floor,'all_floor'=>$all_floor]);
    }
    ...
    return view('edit_category',['edit_category'=>$edit_category,'all_category'=>$all_category]);
    }
